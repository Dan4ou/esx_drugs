		...
		if GetDistanceBetweenCoords(coords, Config.CircleZones.WeedProcessing.coords, true) < 5 then
			...
			if IsControlJustReleased(0, Keys['E']) and not isProcessing then
				...
				if Config.LicenseEnable then
					...
					exports['mythic_notify']:SendAlert('inform', 'Ти преобработваш канабиса!', 2500)
					RequestAnimDict("mp_arresting")
					TaskPlayAnim(GetPlayerPed(-1),"mp_arresting", "a_uncuff", 3.0, 3.0, 9700, 51, 0, false, false, false)
					ProcessWeed()
					exports['mythic_notify']:SendAlert('success', 'Ти превърна канабиса в марихуана!', 3800)
				end
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_illegal:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						Citizen.Wait(1500)
						exports['mythic_notify']:SendAlert('inform', 'Ти откъсна едно листо канабис!', 2500)
